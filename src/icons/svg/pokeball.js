...
function Pokeball({ width = "2rem", height = "2rem", disabled = false }) {
  const defaulColors = ["#fff", "#dfdfdf", "#ff1c1c", "#df1818"];
  const disabledColors = ["#C0C0C0", "#dfdfdf", "#C0C0C0", "#ACACAC"];
  const [color1, color2, color3, color4] = disabled
    ? disabledColors
    : defaulColors;

  return (
    <svg
      id="prefix__Pok\xE9ball"
      ...
      height={height}
    >
      <g id="prefix__Pok\xE9ball_1_">
        <g id="prefix__Colours">
          <path
            id="prefix__Down"
